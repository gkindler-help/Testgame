...
export default class GameScene extends Phaser.Scene {
  ...
  makePlaceholderTextures() {
    ...
    g.fillRect(12, 10, 24, 36);
    g.fillStyle(0xffd6a5, 1);
    g.fillRect(14, 0, 20, 14);
    g.fillStyle(0x3a86ff, 1);
    g.fillRect(8, 18, 6, 18);
    g.fillRect(34, 18, 6, 18);
    ...
    g.fillRect(38, 22, 16, 4);
    g.generateTexture('player', 64, 64);

    g.clear();
    g.fillStyle(0x3d405b, 1);
    g.fillRect(10, 10, 28, 38);
    g.fillStyle(0xf2cc8f, 1);
    g.fillRect(12, 0, 24, 14);
    g.fillStyle(0x81b29a, 1);
    g.fillRect(2, 18, 10, 24);
    g.fillStyle(0x6d597a, 1);
    g.fillRect(36, 22, 20, 8);
    g.fillStyle(0x222222, 1);
    g.fillRect(12, 48, 8, 12);
    g.fillRect(26, 48, 8, 12);
    g.generateTexture('george', 64, 64);

    g.clear();
    g.fillStyle(0xb5179e, 1);
    g.fillRect(10, 16, 30, 32);
    g.fillStyle(0xf1c0e8, 1);
    g.fillRect(14, 2, 22, 16);
    g.fillStyle(0x222222, 1);
    g.fillRect(14, 48, 8, 10);
    g.fillRect(28, 48, 8, 10);
    g.generateTexture('enemy-basic', 56, 64);

    g.clear();
    g.fillStyle(0x2a9d8f, 1);
    g.fillRect(8, 20, 32, 24);
    g.fillStyle(0xb7efc5, 1);
    g.fillRect(12, 6, 24, 18);
    ...
    g.clear();
    g.fillStyle(0x5c677d, 1);
    g.fillRect(18, 24, 92, 72);
    g.fillStyle(0xffadad, 1);
    g.fillRect(34, 0, 60, 30);
    g.fillStyle(0x6c757d, 1);
    g.fillRect(0, 34, 26, 18);
    g.fillRect(110, 34, 26, 18);
    g.fillStyle(0x222222, 1);
    g.fillRect(34, 96, 18, 20);
    g.fillRect(74, 96, 18, 20);
    g.generateTexture('boss', 136, 120);

    g.clear();
    g.fillStyle(0xffd166, 1);
    g.fillRect(0, 0, 18, 6);
    g.generateTexture('bullet-player', 18, 6);

    g.clear();
    g.fillStyle(0xf94144, 1);
    g.fillRect(0, 0, 22, 8);
    g.generateTexture('bullet-george', 22, 8);

    g.clear();
    g.fillStyle(0x90e0ef, 1);
    g.fillRect(0, 0, 14, 6);
    g.generateTexture('bullet-enemy', 14, 6);

    g.clear();
    g.fillStyle(0xff7b00, 1);
    g.fillRect(0, 0, 20, 10);
    g.generateTexture('bullet-flame', 20, 10);
    ...
    g.generateTexture('budget-boost', 32, 32);
    ...
    g.generateTexture('stress-relief', 32, 32);
    ...
    g.generateTexture('life-boost', 32, 32);
    ...
    g.fillCircle(60, 48, 18);
    g.fillCircle(80, 52, 20);
    g.fillCircle(160, 80, 18);
    g.fillCircle(182, 80, 20);
    g.fillCircle(205, 84, 16);
    g.generateTexture('sky-panel', 256, 256);

    g.clear();
    g.fillStyle(0x8ecf7a, 1);
    g.fillRect(0, 80, 256, 176);
    g.fillStyle(0x6ab04c, 1);
    for (let i = 0; i < 8; i++) {
      g.fillTriangle(i * 34, 100, i * 34 + 16, 70, i * 34 + 32, 100);
    }
    g.generateTexture('hill-strip', 256, 256);

    g.clear();
    g.fillStyle(0xf4a261, 1);
    g.fillRect(20, 90, 90, 60);
    g.fillStyle(0xe76f51, 1);
    g.fillTriangle(10, 90, 65, 40, 120, 90);
    g.fillStyle(0xffffff, 1);
    g.fillRect(55, 115, 20, 35);
    g.fillRect(28, 110, 16, 16);
    g.fillRect(85, 110, 16, 16);
    g.fillStyle(0xffffff, 1);
    g.fillRect(145, 100, 70, 50);
    g.fillStyle(0xd62828, 1);
    g.fillTriangle(135, 100, 180, 65, 225, 100);
    g.fillStyle(0x2d6a4f, 1);
    g.fillRect(188, 118, 16, 32);
    g.fillStyle(0xffffff, 1);
    g.fillRect(155, 112, 14, 14);
    g.fillRect(195, 112, 14, 14);
  ...
  setupBackground() {
    for (let x = 0; x < this.worldWidth; x += 256) {
      this.add.image(x, 128, 'sky-panel').setOrigin(0, 0).setScrollFactor(0.15);
    }

    for (let x = 0; x < this.worldWidth; x += 256) {
      this.add.image(x, 400, 'hill-strip').setOrigin(0, 0).setScrollFactor(0.35);
    }

    for (let x = 0; x < this.worldWidth; x += 256) {
      this.add.image(x, 490, 'suburb-strip').setOrigin(0, 0).setScrollFactor(0.55);
    }

    for (let x = 250; x < this.worldWidth; x += 480) {
      this.add.image(x, this.groundY - 18, 'for-sale-sign').setOrigin(0.5, 1);
    }

    const ground = this.add.graphics();
    ground.fillStyle(0x6a994e, 1);
    ground.fillRect(0, this.groundY, this.worldWidth, this.worldHeight - this.groundY);
    ground.fillStyle(0x4f772d, 1);
    ground.fillRect(0, this.groundY, this.worldWidth, 18);
  }
  ...
  setupEntities() {
    ...
    this.georgeBullets = this.physics.add.group({
      allowGravity: false,
      immovable: true
    });
    ...
    const enemyData = [
      { x: 650, y: 590, type: 'listing' },
      { x: 1080, y: 500, type: 'goblin' },
      { x: 1350, y: 740, type: 'gremlin' },
      { x: 1700, y: 740, type: 'listing' },
      { x: 2050, y: 480, type: 'goblin' },
      { x: 2320, y: 740, type: 'gremlin' },
      { x: 2680, y: 740, type: 'listing' },
      { x: 3120, y: 500, type: 'goblin' },
      { x: 3520, y: 740, type: 'gremlin' },
      { x: 3990, y: 500, type: 'listing' },
      { x: 4320, y: 740, type: 'gremlin' }
    ];
  ...
  setupControls() {
    ...
    this.joystick = this.plugins.get('rexvirtualjoystickplugin').add(this, {
      x: Math.max(120, width * 0.17),
      y: height - Math.max(120, height * 0.16),
      radius: 75,
      fixed: true,
      dir: '8dir',
      forceMin: 8,
      base: this.add.circle(0, 0, 72, 0x0b132b, 0.35)
        .setStrokeStyle(4, 0xffffff, 0.35)
        .setScrollFactor(0),
      thumb: this.add.circle(0, 0, 34, 0x3a86ff, 0.9)
  ...
  setupButtons() {
    ...
    this.btnJump.on('pointerdown', () => {
      this.jumpHeld = true;
      this.player.tryJump();
      this.pressButtonVisual(this.btnJump, true);
    });
    this.btnJump.on('pointerup', () => {
      this.jumpHeld = false;
      this.pressButtonVisual(this.btnJump, false);
    });
    ...
    this.btnShoot.on('pointerdown', () => {
      this.shootHeld = true;
      this.playerShoot();
      this.pressButtonVisual(this.btnShoot, true);
    });
    this.btnShoot.on('pointerup', () => {
      this.shootHeld = false;
      this.pressButtonVisual(this.btnShoot, false);
    });
    ...
    this.btnGun.on('pointerdown', () => {
      ...
      this.time.delayedCall(180, () => {
        this.changeGunCooldown = false;
        this.pressButtonVisual(this.btnGun, false);
      });
    });
  ...
  createTouchButton(x, y, w, h, label, color) {
    ...
    const bg = this.add.rectangle(0, 0, w, h, color, 0.9)
  ...
  repositionTouchUI(gameSize) {
    ...
    if (this.joystick) {
      this.joystick.setPosition(
        Math.max(120, width * 0.17),
        height - Math.max(120, height * 0.16)
      );
    }
  ...
  onPlayerBulletHitsEnemy(bullet, enemy) {
    ...
    if (enemy.hp <= 0) {
      this.increaseStress(-4);
      this.increaseBudget(3);
    }
  }
  ...
  onGeorgeBulletHitsEnemy(bullet, enemy) {
    ...
    enemy.takeDamage(34);
    if (enemy.hp <= 0) {
      this.increaseStress(-6);
      this.increaseBudget(5);
    }
  }
  ...
  onEnemyTouchesPlayer(player, enemy) {
    if (!enemy.touchCooldown) {
      ...
      this.time.delayedCall(700, () => {
        if (enemy && enemy.active) enemy.touchCooldown = false;
      });
    }
  }
  ...
  setupHUD() {
    ...
    this.hudBg = this.add.rectangle(16, 16, Math.min(this.scale.width * 0.66, 520), 130, 0x000000, 0.34)
      .setOrigin(0, 0)
      .setStrokeStyle(2, 0xffffff, 0.2);

    this.hudTitle = this.add.text(28, 22, 'THE HOME BATTLE: BUYER BEWARE', {
      fontFamily: 'Arial, Helvetica, sans-serif',
      fontSize: '20px',
      fontStyle: 'bold',
      color: '#ffffff'
    ...
    this.budgetLabel = this.add.text(28, 52, 'Budget', {
      fontFamily: 'Arial',
      fontSize: '18px',
      color: '#ffffff'
    });

    this.stressLabel = this.add.text(28, 82, 'Stress', {
      fontFamily: 'Arial',
      fontSize: '18px',
      color: '#ffffff'
    });
    ...
    this.livesText = this.add.text(310, 52, 'Lives: 3', {
      fontFamily: 'Arial',
      fontSize: '18px',
      color: '#ffffff'
    });

    this.gunText = this.add.text(310, 76, 'Gun: Basic Pre-Approval Pistol', {
      fontFamily: 'Arial',
      fontSize: '17px',
      color: '#ffffff',
      wordWrap: { width: 220 }
    ...
    this.agentText = this.add.text(310, 102, 'Agent Status: Offline', {
      fontFamily: 'Arial',
      fontSize: '18px',
      color: '#ffb703'
    });
    ...
    this.bossBarBg = this.add.rectangle(this.scale.width * 0.5, 26, Math.min(420, this.scale.width * 0.55), 18, 0x222222, 0.9)
      .setScrollFactor(0)
      .setDepth(1500)
      .setVisible(false);

    this.bossBar = this.add.rectangle(
      this.bossBarBg.x - this.bossBarBg.width / 2,
      26,
      this.bossBarBg.width,
      18,
      0xe63946
    ).setOrigin(0, 0.5)
     .setScrollFactor(0)
    ...
    this.bossText = this.add.text(this.scale.width * 0.5, 4, 'THE ESCROW BEAST', {
      fontFamily: 'Arial',
      fontSize: '18px',
      fontStyle: 'bold',
      color: '#ffffff'
  ...
  showIntroBanner() {
    const banner = this.add.text(this.scale.width * 0.5, this.scale.height * 0.18,
      'SURVIVE THE HOMEBUYING CHAOS\nAND CALL GEORGE WHEN IT GETS REAL',
      {
        fontFamily: 'Arial',
        fontSize: '26px',
        fontStyle: 'bold',
    ...
    if (bulletData.type === 'flame') {
      for (let i = 0; i < 2; i++) {
        ...
        const bullet = this.playerBullets.create(
          this.player.x + bulletData.offsetX * this.player.facing,
          this.player.y - 12 + spreadY,
          'bullet-flame'
        );
  ...
  georgeShootAtTarget(target) {
    ...
    const bullet = this.georgeBullets.create(
      this.george.x + 26 * this.george.facing,
      this.george.y - 18,
      'bullet-george'
    );
    bullet.body.allowGravity = false;
  ...
  activateGeorge() {
    if (this.gameEnded) return;
    if (this.george.activePartner) return;
    if (this.callAgentCooldown) return;
    ...
    const banner = this.add.text(this.scale.width * 0.5, this.scale.height * 0.24,
      'GEORGE HAS ENTERED THE BATTLE',
      {
        fontFamily: 'Arial',
        fontSize: '28px',
        fontStyle: 'bold',
  ...
  increaseBudget(value) {
    this.budget = Phaser.Math.Clamp(this.budget + value, 0, 100);
  }

  increaseStress(value) {
  ...
  showGameOver() {
    ...
    this.showEndCard(
      'GAME OVER',
      'Your budget or stress meter hit zero.\nIn this game and in real life, support matters.\nReset the repo page to play again.'
    );
  }
  ...
  showWin() {
    ...
    this.showEndCard(
      'DEAL CLOSED!',
      'George helped you survive the process.\nA strong real estate agent can help you spot issues,\nmanage chaos, negotiate harder, and get deals to the finish line.'
    );
  }
  ...
  showEndCard(title, body) {
    ...
    const panel = this.add.rectangle(
      this.scale.width * 0.5,
      this.scale.height * 0.5,
      Math.min(this.scale.width * 0.84, 700),
      Math.min(this.scale.height * 0.54, 360),
      0x1f2937,
      0.95
    ...
    const bodyText = this.add.text(
      ...
      body,
      {
        ...
        color: '#f1f5f9',
        align: 'center',
        wordWrap: { width: Math.min(this.scale.width * 0.68, 560) }
      }
    ).setOrigin(0.5).setScrollFactor(0).setDepth(3002);

    const tip = this.add.text(
      this.scale.width * 0.5,
      this.scale.height * 0.5 + 105,
    ...
    this.endCardObjects = [overlay, panel, titleText, bodyText, tip];
  }
  ...
  update(time, delta) {
    ...
    if (this.shootHeld || keyboardShoot) {
      this.playerShoot();
    }
  ...
  getPriorityTarget() {
    if (this.boss && this.boss.active && Phaser.Math.Distance.Between(this.george.x, this.george.y, this.boss.x, this.boss.y) < 1200) {
      return this.boss;
    }
